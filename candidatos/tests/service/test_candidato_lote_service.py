...
def payload_exemplo() -> Any:
    ...
    return {'concurso_uuid': 'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', 'concurso_nome': 'Concurso X', 'candidatos': [{'nome': 'Fulano', 'cpf': '111.111.111-11', 'email': 'f1@example.com', 'data_nascimento': '01/01/1990', 'codigo_inscricao': '123', 'pontos': 0}, {'nome': 'Beltrano', 'cpf': '222.222.222-22', 'email': 'f2@example.com', 'data_nascimento': '02/02/1991', 'codigo_inscricao': '456', 'pontos': 0}]}

def test_processar_criacao_candidatos_lote_cria_lote_e_relacionamentos() -> None:
...
def test_processar_criacao_candidatos_lote_sem_concurso_uuid_retorna_400() -> None:
    """Verifica processar criacao candidatos lote sem concurso uuid retorna 400."""
    p = payload_exemplo()
    del p['concurso_uuid']
