...
def test_remover_agendas_200_retorna_json(mock_delete: Any) -> None:
...
@patch("candidatos.service.agendas_api_service.http_client.delete")
def test_remover_agendas_nao_200_levanta_erro(mock_delete: Any) -> None:
...
@patch("candidatos.service.agendas_api_service.http_client.delete")
def test_remover_agendas_request_exception_propaga(mock_delete: Any) -> None:
