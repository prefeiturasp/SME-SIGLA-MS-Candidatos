...
@patch('candidatos.service.escolhas_service.http_client.get')
def test_buscar_reconvocacoes_200_dict_sem_results_retorna_lista_unitária(mock_get: Any) -> None:
    """Verifica buscar reconvocacoes 200 dict sem results retorna lista unitária."""
    mock_get.return_value.status_code = 200
...
@patch('candidatos.service.escolhas_service.http_client.get')
def test_buscar_reconvocacoes_200_outro_formato_retorna_lista_vazia(mock_get: Any) -> None:
...
@patch('candidatos.service.escolhas_service.http_client.get')
def test_buscar_reconvocacoes_nao_200_levanta_request_exception(mock_get: Any) -> None:
...
@patch('candidatos.service.escolhas_service.http_client.get')
def test_buscar_escolhas_200_dict_sem_results_retorna_lista_unitária(mock_get: Any) -> None:
...
def test_buscar_reconvocacoes_connection_error_levanta_request_exception(settings: Any) -> None:
    """Verifica buscar reconvocacoes connection error levanta request exception."""
    settings.ESCOLHAS_API_URL = 'http://escolhas'
...
def test_buscar_reconvocacoes_timeout_levanta_request_exception(settings: Any) -> None:
...
def test_buscar_escolhas_connection_error_levanta_request_exception(settings: Any) -> None:
...
def test_buscar_escolhas_timeout_levanta_request_exception(settings: Any) -> None:
