...
def test_buscar_agrupa_concursos_por_candidato(
    ...
    ConcursoCandidato.objects.create(
        candidato=candidato, lote=lote1, codigo_inscricao="A1"
    )
    ConcursoCandidato.objects.create(
        candidato=candidato, lote=lote2, codigo_inscricao="A2"
    )
...
def test_buscar_com_multiplos_parametros(
    ...
    ConcursoCandidato.objects.create(
        candidato=c1, lote=lote, codigo_inscricao="1"
    )
    ConcursoCandidato.objects.create(
        candidato=c2, lote=lote, codigo_inscricao="2"
    )
    response = api_client.get(
