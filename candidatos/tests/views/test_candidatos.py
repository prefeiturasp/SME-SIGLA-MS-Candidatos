...
def test_list_candidatos(api_client: Any, candidatos_criados: Any, candidato_url: Any) -> None:
    ...
    Args:
        ...
        candidatos_criados: Parâmetro candidatos criados da operação.
        candidato_url: Parâmetro candidato url da operação.
...
def test_buscar_sem_parametros_retorna_400(api_client: Any, buscar_url: Any) -> None:
    ...
    Args:
        api_client: Cliente de API para requisições de teste.
        buscar_url: Parâmetro buscar url da operação.
