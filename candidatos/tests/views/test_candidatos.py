...
def test_buscar_por_nome_retorna_candidatos(api_client, buscar_url):
    ...
    candidato = Candidato.objects.create(
        nome='Fulano da Silva', cpf='11122233344', email='fulano@email.com',
...
def test_buscar_por_cpf_retorna_candidatos(api_client, buscar_url):
    lote = ConcursoCandidatosLote.objects.create(concurso_uuid=uuid4(), concurso_nome='Concurso X')
    candidato = Candidato.objects.create(
        nome='Beltrano', cpf='55566677788', email='beltrano@email.com',
        telefone='', data_nascimento='1990-01-01', genero='M',
        endereco='', cidade='', estado='', cep='', status='ativo', observacoes=''
    )
    ConcursoCandidato.objects.create(
        candidato=candidato, lote=lote, codigo_inscricao='002'
    )
...
def test_buscar_por_rg_retorna_candidatos(api_client, buscar_url):
    lote = ConcursoCandidatosLote.objects.create(concurso_uuid=uuid4(), concurso_nome='Concurso X')
    candidato = Candidato.objects.create(
        nome='Cicrano', cpf='99988877766', email='cicrano@email.com',
        rg='12.345.678-9', telefone='', data_nascimento='1990-01-01', genero='M',
        endereco='', cidade='', estado='', cep='', status='ativo', observacoes=''
    )
    ConcursoCandidato.objects.create(
        candidato=candidato, lote=lote, codigo_inscricao='003'
    )
...
def test_buscar_por_registro_funcional_retorna_candidatos(api_client, buscar_url):
    lote = ConcursoCandidatosLote.objects.create(concurso_uuid=uuid4(), concurso_nome='Concurso X')
    candidato = Candidato.objects.create(
        nome='Registro', cpf='12312312312', email='registro@email.com',
        registro_funcional='RF12345', telefone='', data_nascimento='1990-01-01', genero='M',
        endereco='', cidade='', estado='', cep='', status='ativo', observacoes=''
    )
    ConcursoCandidato.objects.create(
        candidato=candidato, lote=lote, codigo_inscricao='004'
    )
...
def test_buscar_agrupa_concursos_por_candidato(api_client, buscar_url):
    """Candidato com mais de um ConcursoCandidato deve retornar um único item com lista de concursos."""
    concurso_uuid = uuid4()
    ...
    candidato = Candidato.objects.create(
        nome='Multi Concurso', cpf='77777777777', email='multi@email.com',
        telefone='', data_nascimento='1990-01-01', genero='M',
        endereco='', cidade='', estado='', cep='', status='ativo', observacoes=''
    )
...
def test_buscar_retorna_lista_vazia_quando_nao_encontra(api_client, buscar_url):
...
def test_buscar_nome_icontains(api_client, buscar_url):
    ...
    lote = ConcursoCandidatosLote.objects.create(concurso_uuid=uuid4(), concurso_nome='Concurso X')
    candidato = Candidato.objects.create(
        nome='Maria Fernanda Santos', cpf='44455566677', email='maria.f@email.com',
        telefone='', data_nascimento='1990-01-01', genero='F',
        endereco='', cidade='', estado='', cep='', status='ativo', observacoes=''
    )
    ConcursoCandidato.objects.create(
        candidato=candidato, lote=lote, codigo_inscricao='005'
    )
