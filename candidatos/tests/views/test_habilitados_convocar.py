"""Módulo tests/views/test_habilitados_convocar."""
...
def candidatos_no_lote(lote: Any) -> Any:
    ...
    cc2 = ConcursoCandidato.objects.create(lote=lote, candidato=cand2, codigo_inscricao='A2', descricao_cargo='Cargo X')
    return (cc1, cc2)
