...
class ConcursoCandidato(BaseModel):
    ...
    categoria_efetiva = models.CharField(max_length=10, choices=CATEGORIA_CHOICES, default='GERAL', db_index=True, verbose_name='Categoria Efetiva')
    promovido_para_geral = models.BooleanField(default=False, verbose_name='Promovido para Geral')
    promovido_de = models.CharField(max_length=10, choices=(('NNA', 'NNA'), ('PCD', 'PCD')), blank=True, null=True, verbose_name='Promovido de')
