...
class Candidato(BaseModel):
    ...
    registro_funcional = models.CharField(
        max_length=50, blank=True, verbose_name="Registro Funcional"
    )
    vinculo = models.CharField(
        max_length=100, blank=True, verbose_name="Vínculo"
    )
    data_nascimento = models.DateField(default=date.today)
    genero = models.CharField(
        max_length=1, choices=GENERO_CHOICES, blank=True, verbose_name="Gênero"
    )
    ...
    bairro = models.CharField(
        max_length=120, blank=True, verbose_name="Bairro"
    )
    cidade = models.CharField(
        max_length=100, blank=True, verbose_name="Cidade"
    )
