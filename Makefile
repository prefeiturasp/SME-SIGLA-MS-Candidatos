...
PEP_APP_DIRS = apps/candidatos apps/parametrizacao
...
coverage:
	...
	pytest --ds=config.settings_test --cov=candidatos --cov-report=term-missing --cov-report=html
