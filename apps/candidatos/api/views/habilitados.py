...
class HabilitadosViewSet(viewsets.ModelViewSet):
    ...
    def reclassificar(self, request: Any) -> Any:
        ...
        return Response(
            {
                "concurso_candidato": ConcursoCandidatoRepository.serializar(
                    cc
                ),
    ...
    def desconvocar(self, request: Any) -> Any:
        ...
        qs = ConcursoCandidatoRepository.filtrar_convocados_por_processo(
            processo_uuid=processo_uuid, codigo_cargo=codigo_cargo
        )
        atualizados = list(ConcursoCandidatoRepository.listar_uuids(qs))
        ConcursoCandidatoRepository.desmarcar_convocados(qs)
        if codigo_cargo:
            try:
    ...
    def buscar_por_uuids(self, request: Any) -> Any:
        ...
        try:
            queryset = ConcursoCandidatoRepository.filtrar_por_uuids(
                uuids, order_by=order_by_param
            )
        except FieldError:
            return Response(
    ...
    def buscar_por_cpfs(self, request: Any) -> Any:
        ...
        try:
            queryset = ConcursoCandidatoRepository.filtrar_por_cpfs_e_processo(
                cpfs=cpfs,
                processo_uuid=processo_uuid,
        ...
        return Response(
            ConcursoCandidatoRepository.serializar_cpf_uuid(queryset)
        )
