...
def _criar_candidato(nome, cpf, email):
        ...
        lotes=[
            {
                ...
                "empresa": 1,
                "vaga": 10,
                "identificacao": "INSC001",
                "chave_inscrito": "CHV-123",
                "numfunc": "RF001",
                "numvinc": "V001",
            }
        ],
            ...
            lotes=[
                {
                    ...
                    "empresa": 1,
                    "vaga": 12,
                    "identificacao": "INSC003",
                    "chave_inscrito": "CHV-NEW",
                    "numfunc": "RF003",
                    "numvinc": "V003",
                },
                {
                    ...
                    "empresa": 1,
                    "vaga": 13,
                    "identificacao": "INSC999",
                    "chave_inscrito": "CHV-ERR",
                    "numfunc": "RF004",
                    "numvinc": "V004",
                },
            ],
