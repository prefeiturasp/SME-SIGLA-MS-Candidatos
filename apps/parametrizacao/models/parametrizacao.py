...
class Parametrizacao(BaseModel):
    ...
    porcentagem_pcd = models.FloatField(
        ...
        help_text=(
            "Porcentagem padrão para cálculo de habilitados PCD "
            "(padrão: 0.05 = 5%)"
        ),
    )
    porcentagem_nna = models.FloatField(
        ...
        help_text=(
            "Porcentagem padrão para cálculo de habilitados NNA "
            "(padrão: 0.20 = 20%)"
        ),
    )
    ...
    def __str__(self) -> Any:
        ...
        return (
            f"Parametrização - PCD: {self.porcentagem_pcd}, "
            f"NNA: {self.porcentagem_nna}"
        )
